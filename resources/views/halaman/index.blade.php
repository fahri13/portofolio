    ...
    <div class="container">
        ...
        <div class="w-full pt-10 border-t border-slate-700">
            <div class="flex items-center justify-center mb-5">
                ...
                <p class="font-medium text-sm text-slate-500 text-center text-[0.75rem]">Dibuat Oleh <a href="Tuanmuda" class="font-bold text-primary">Tuanmuda</a> <span class="text-primary">❤</span> menggunakan <a href="" class="font-bold text-sky-500">Tailwind CSS</a></p>
        </div>
    </div>
 </section>
 <!-- Footer section end -->
